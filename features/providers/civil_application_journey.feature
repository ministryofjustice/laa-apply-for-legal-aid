Feature: Civil application journeys
  ...
  Scenario: I am able to view the client completed means answers
    ...
    #
    #
    # This last line to be re-instated once the full means assessment results page has been implemented
    #
    #
#    Then I should be on a page showing 'Provide details of the case'
  ...
  Scenario: Completes the merits application for applicant that does not receive passported benefits
    ...
    #
    #
    # The rest of this test should be re-instated once the full means assessment results page has been implemented
    #
    #
#    Then I should be on a page showing 'Provide details of the case'
#    Then I click 'Continue'
