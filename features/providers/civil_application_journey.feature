Feature: Civil application journeys
  ...
  @javascript @vcr
  Scenario: Application requires a contribution
    Given I complete the passported journey as far as check your answers
    Then I click 'Save and continue'
    Then I should be on a page showing 'receives benefits that qualify for legal aid'
    Then I click 'Continue'
    ...
    Then I should be on a page showing "Check your answers"
    Then I click 'Save and continue'
    Then I should be on a page showing 'Test Walker may need to pay towards legal aid'
    Then I should be on a page showing 'We’ve calculated that your client should pay'

  @javascript @vcr
  Scenario: Application needs to be reviewed
    Given I complete the passported journey as far as check your answers
    Then I click 'Save and continue'
    Then I should be on a page showing 'receives benefits that qualify for legal aid'
    Then I click 'Continue'
    ...
    Then I click 'Save and continue'
    Then I should be on a page showing 'We need to check if Test Walker should pay towards legal aid'
    Then I should be on a page showing 'We’ll check the details you provided and let you know our decision.'

  @javascript @vcr
  Scenario: Does not need to make a contribution no review
    Given I complete the passported journey as far as check your answers
    Then I click 'Save and continue'
    Then I should be on a page showing 'receives benefits that qualify for legal aid'
    Then I click 'Continue'
    ...
    Then I click 'Save and continue'
    Then I should be on a page showing "How much is your client's home worth?"
    Then I fill "Property value" with "150000"
    Then I click 'Save and continue'
    Then I should be on a page showing "What is the outstanding mortgage on your client's home?"
    Then I fill "Outstanding mortgage amount" with "100000"
    Then I click 'Save and continue'
    ...
    Then I should be on a page showing "Check your answers"
    Then I click 'Save and continue'
    Then I should be on a page showing 'Test Walker could be eligible for legal aid'
    Then I should be on a page showing 'Based on their financial situation, your client may not have to pay towards legal aid.'
