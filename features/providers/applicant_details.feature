Feature: Applicant details
  @javascript @vcr @billy @stub_pda_contracts_endpoint
  Scenario: Completes the application using address lookup with multiple proceedings
    ...
    Then proceeding suggestions has results
    Then I choose a 'Female genital mutilation (FGM) protection order' radio button
    Then I click 'Save and continue'
    Then I should be on a page showing 'You have added 1 proceeding'
    Then I should be on a page showing 'Female genital mutilation (FGM) protection order'
    Then I should be on a page showing 'Do you want to add another proceeding?'
    Then I choose 'Yes'
    Then I click 'Save and continue'
    Then I search for proceeding 'Occupation order'
    ...
    Then I should be on a page showing 'Proceeding 1 Female genital mutilation (FGM) protection order'
    ...
    Then I should be on a page showing 'Female genital mutilation (FGM) protection order proceeding details'
  ...
  Scenario: Completes the application using manual address
    ...
    Then I choose a 'Child arrangements order (CAO) - residence' radio button
    Then I click 'Save and continue'
    Then I should be on a page showing 'Do you want to add another proceeding?'
    When I choose 'No'
    And I click 'Save and continue'
  ...
  @javascript @vcr @billy @stub_pda_contracts_endpoint @stub_pda_contracts_endpoint
