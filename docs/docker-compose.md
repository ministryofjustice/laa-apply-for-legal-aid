...
- append the following env vars to the `.env.docker-compose`
...
POSTGRES_PORT=5432
POSTGRES_USER=<password for DB in the postgres image used>
...
REDIS_PORT=6379
REDIS_PASSWORD:<password for DB in the Redis image used>

# docker compose dummy vars for  AWS S3 connection are required to prevent errors on startup
AWS_ACCESS_KEY_ID=dummy
AWS_SECRET_ACCESS_KEY=dummy
AWS_REGION=<region expect>
