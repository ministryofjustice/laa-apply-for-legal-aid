...
module LaaApplyForLegalAid
  class Application < Rails::Application
    ...
    config.x.ccms_user_api.url = ENV.fetch("CCMS_USER_API_URL", nil) # https://laa-ccms-user-management-api-dev.apps.live.cloud-platform.service.justice.gov.uk/api/v1/
