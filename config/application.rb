...
module LaaApplyForLegalAid
  class Application < Rails::Application
    ...
    config.x.user_api.url = ENV.fetch("USER_API_URL", nil) # https://laa-ccms-user-management-api-dev.apps.live.cloud-platform.service.justice.gov.uk/api/v1/
    config.x.user_api.auth_key = ENV.fetch("USER_API_AUTH_KEY", nil)
