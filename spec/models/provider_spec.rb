  ...
  describe "#announcements" do
    ...
    context "when there are multiple types of alerts" do
      before do
        ...
        Announcement.create!(display_type: :moj, heading: "You won't believe this new feature", start_at: Time.zone.local(2025, 11, 11, 9, 0), end_at: Time.zone.local(2025, 12, 11, 9, 0))
      end
      ...
      context "when the provider has dismissed the feature announcement" do
        before do
          ProviderSkippedAnnouncement.create!(provider:, announcement: Announcement.find_by(heading: "You won't believe this new feature"))
        end
