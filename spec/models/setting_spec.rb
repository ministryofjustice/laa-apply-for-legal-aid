...
RSpec.describe Setting do
  describe ".setting" do
    context "when there is no setting record" do
      ...
      it "generates one with the default values" do
        ...
        expect(rec.benefit_checker_unavailable?).to be false
      end
    end
    ...
    context "when a record already exists with non-default values" do
      before do
        described_class.setting.update!(
          ...
          benefit_checker_unavailable: true,
        )
      end
      ...
      it "returns the existing record" do
        ...
        expect(rec.benefit_checker_unavailable?).to be true
      end
    end
  end
  ...
  describe "class methods" do
    ...
    it "returns the value with a class method" do
      ...
      expect(described_class.benefit_checker_unavailable?).to be false
    end
  end
end
