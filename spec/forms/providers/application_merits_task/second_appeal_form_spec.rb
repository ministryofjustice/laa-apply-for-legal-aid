...
RSpec.describe Providers::ApplicationMeritsTask::SecondAppealForm do
  ...
  describe "#save" do
    ...
    context "when the form is invalid" do
      ...
      it "does not update the record" do
        expect { save_form }.not_to change { legal_aid_application.reload.second_appeal }.from(nil)
      end
    end
    ...
    context "when second_appeal is true" do
      ...
      it "updates the record" do
        expect { save_form }.to change { legal_aid_application.reload.second_appeal }.from(nil).to(true)
      end
    end
    ...
    context "when second_appeal is false" do
      ...
      it "updates the record" do
        expect { save_form }.to change { legal_aid_application.reload.second_appeal }.from(nil).to(false)
      end
    end
  end
  ...
  describe "#save_as_draft" do
    ...
    context "when the form is invalid" do
      ...
      it "does not update the record" do
        expect { save_as_draft }.not_to change { legal_aid_application.reload.second_appeal }.from(nil)
      end
    end
    ...
    context "when second_appeal is true" do
      ...
      it "updates the record" do
        expect { save_as_draft }.to change { legal_aid_application.reload.second_appeal }.from(nil).to(true)
      end
    end
    ...
    context "when second_appeal is false" do
      ...
      it "updates the record" do
        expect { save_as_draft }.to change { legal_aid_application.reload.second_appeal }.from(nil).to(false)
      end
    end
  end
end
