...
RSpec.describe Flow::Steps::ProviderIncome::StudentFinancesStep, type: :request do
  let(:legal_aid_application) { create(:legal_aid_application) }

  describe "#path" do
    subject { described_class.path.call(legal_aid_application) }

    it { is_expected.to eql providers_legal_aid_application_means_student_finance_path(legal_aid_application) }
  end
  ...
  describe "#forward" do
    ...
    context "when application has attached bank statement(s)" do
      ...
      it { is_expected.to eq :regular_outgoings }
    end
    ...
    context "when application does not have attached bank statement(s)" do
      ...
      it { is_expected.to eq :identify_types_of_outgoings }
    end
  end
