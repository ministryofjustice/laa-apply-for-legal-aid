...
RSpec.describe Flow::Steps::ProviderMerits::AttemptsToSettleStep, type: :request do
  before do
  ...
  describe "#path" do
    ...
    it { is_expected.to eq providers_merits_task_list_attempts_to_settle_path(proceeding) }
  end
