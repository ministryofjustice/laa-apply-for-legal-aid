...
RSpec.describe Flow::Steps::ProviderMerits::ProhibitedStepsStep, type: :request do
  before do
  ...
  describe "#path" do
    ...
    it { is_expected.to eq providers_merits_task_list_prohibited_steps_path(proceeding) }
  end
