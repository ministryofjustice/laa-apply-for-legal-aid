...
RSpec.describe Flow::Steps::ProviderMerits::ChildSubjectStep, type: :request do
  ...
  describe "#path" do
    ...
    it { is_expected.to eq providers_merits_task_list_is_client_child_subject_path(proceeding) }
  end
