...
RSpec.describe Flow::Steps::ProviderMerits::SuccessProspectsStep, type: :request do
  before do
  ...
  describe "#path" do
    ...
    it { is_expected.to eq providers_merits_task_list_success_prospects_path(proceeding) }
  end
