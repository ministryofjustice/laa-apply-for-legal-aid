...
RSpec.describe Flow::Steps::ProviderMerits::OpponentsApplicationStep, type: :request do
  before do
  ...
  describe "#path" do
    ...
    it { is_expected.to eq providers_merits_task_list_opponents_application_path(proceeding) }
  end
