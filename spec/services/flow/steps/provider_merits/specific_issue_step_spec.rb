...
RSpec.describe Flow::Steps::ProviderMerits::SpecificIssueStep, type: :request do
  before do
  ...
  describe "#path" do
    ...
    it { is_expected.to eq providers_merits_task_list_specific_issue_path(proceeding) }
  end
