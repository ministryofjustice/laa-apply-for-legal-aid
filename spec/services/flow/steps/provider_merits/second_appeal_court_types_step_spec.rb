...
RSpec.describe Flow::Steps::ProviderMerits::SecondAppealCourtTypesStep, type: :request do
  ...
  describe "#path" do
    ...
    it { is_expected.to eq providers_legal_aid_application_second_appeal_court_type_path(legal_aid_application) }
  end
