...
RSpec.describe Flow::Steps::ProviderApplicationMerits::ParentalResponsibilitiesStep, type: :request do
  ...
  describe "#path" do
    ...
    it { is_expected.to eq providers_legal_aid_application_client_has_parental_responsibility_path(legal_aid_application) }
  end
