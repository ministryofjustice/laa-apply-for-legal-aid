...
RSpec.describe Flow::Steps::Addresses::DifferentAddressReasonsStep, type: :request do
  ...
  describe "#path" do
    ...
    it { is_expected.to eq providers_legal_aid_application_home_address_different_address_reason_path(legal_aid_application) }
  end
