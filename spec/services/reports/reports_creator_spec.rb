...
RSpec.describe Reports::ReportsCreator do
  let(:legal_aid_application) { create :legal_aid_application, :with_proceeding_types, :with_positive_benefit_check_result, :with_everything, state: :generating_reports }
