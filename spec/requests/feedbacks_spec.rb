...
RSpec.describe "FeedbacksController", type: :request do
  describe "POST /feedback" do
    ...
    describe "creation of feedback record" do
      ...
      context "when logged in as a provider" do
        ...
        context "with feedback given during application" do
          let(:page_history) do
        ...
        context "with feedback given outside of an application" do
          let(:page_history) do
            ["/feedback/new"]
          end
  ...
  describe "GET /feedback/new" do
    ...
    context "when has come here as applicant or signed in provider" do
      let(:session_vars) { {} }
