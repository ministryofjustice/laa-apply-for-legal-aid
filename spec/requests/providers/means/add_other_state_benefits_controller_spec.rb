...
RSpec.describe Providers::Means::AddOtherStateBenefitsController do
  ...
  describe "GET /providers/applications/:legal_aid_application_id/means/add_other_state_benefits" do
    subject(:make_request) { get providers_legal_aid_application_means_add_other_state_benefits_path(legal_aid_application) }
    ...
    context "when the provider is authenticated" do
      context "and no benefits have been added" do
        it "returns the expected page with the correct heading" do
          ...
          expect(response.body).to include("Does your client receive any other benefits, charitable or government payments?")
        end
      end
  ...
  describe "PATCH /providers/applications/:legal_aid_application_id/means/add_other_state_benefits" do
    subject(:make_request) { patch providers_legal_aid_application_means_add_other_state_benefits_path(legal_aid_application), params: }
