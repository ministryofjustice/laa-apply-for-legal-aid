...
RSpec.describe Providers::Means::IdentifyIncomesController do
  describe "GET /providers/applications/:legal_aid_application_id/means/identify_incomes" do
    it "returns ok" do
      ...
      get providers_legal_aid_application_means_identify_incomes_path(legal_aid_application)
  ...
  describe "PATCH /providers/applications/:legal_aid_application_id/means/identify_incomes" do
    context "when none is selected" do
      it "updates the application and redirects to the student finance page" do
        ...
        login_as provider
        Setting.setting.update!(enhanced_bank_upload: true)
        params = { providers_means_identify_income_form: { income_types: ["", "none"] } }

        patch providers_legal_aid_application_means_identify_incomes_path(legal_aid_application), params: params
    ...
    context "when regular payments are selected" do
      it "updates the application and redirects to the cash income page" do
        ...
        Setting.setting.update!(enhanced_bank_upload: true)
        params = {
          providers_means_identify_income_form: {
        ...
        identified_income = legal_aid_application.regular_payments.credits
    ...
    context "when the form is invalid" do
      it "returns unprocessable entity, renders errors, and does not update the application" do
        ...
        benefits = create(:transaction_type, :benefits)
        maintenance_in_payment = create(:regular_payment, :maintenance_in, legal_aid_application:)
        provider = legal_aid_application.provider
        login_as provider
        Setting.setting.update!(enhanced_bank_upload: true)
        params = {
    ...
    context "when checking answers and regular payments are selected" do
      it "updates the application and redirects to the cash income page" do
        legal_aid_application = create(
          :legal_aid_application,
          :with_non_passported_state_machine,
    ...
    context "when the provider is not authenticated" do
      it "redirects to the provider login page" do
        ...
        patch providers_legal_aid_application_means_identify_incomes_path(legal_aid_application)
