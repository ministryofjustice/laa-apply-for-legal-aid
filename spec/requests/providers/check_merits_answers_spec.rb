  ...
  describe 'GET /providers/applications/:id/check_merits_answers' do
    ...
    context 'logged in as an authenticated provider' do
      ...
      it 'displays the correct questions' do
        ...
        expect(response.body).to include(I18n.translate('providers.check_merits_answers.non_domestic_abuse_answers.items.client_received_legal_help'))
        expect(response.body).to include(I18n.translate('providers.check_merits_answers.non_domestic_abuse_answers.items.proceedings_currently_before_court'))
