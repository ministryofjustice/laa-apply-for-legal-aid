...
RSpec.describe Providers::OutgoingsSummaryController, type: :request do
  ...
  describe 'POST /providers/income_summary' do
    ...
    it 'redirects to the next page' do
      expect(response).to redirect_to(providers_legal_aid_application_own_home_path(legal_aid_application))features/providers/civil_application_journey.feature:721
    end
