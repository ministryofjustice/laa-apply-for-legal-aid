...
RSpec.describe Providers::Partners::RemoveStateBenefitsController do
  ...
  describe "GET /providers/:application_id/means/remove_state_benefits/:regular_transaction_id" do
    subject(:make_request) { get providers_legal_aid_application_partners_remove_state_benefit_path(legal_aid_application, chosen_transaction) }
  ...
  describe "PATCH /providers/:application_id/means/remove_state_benefits/:regular_transaction_id" do
    subject(:make_request) { patch providers_legal_aid_application_partners_remove_state_benefit_path(legal_aid_application, chosen_transaction), params: }
