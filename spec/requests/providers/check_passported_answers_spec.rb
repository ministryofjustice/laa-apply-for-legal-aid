  ...
  describe 'GET /providers/applications/:id/check_passported_answers' do
    ...
    context 'logged in as an authenticated provider' do
      ...
      context 'applicant does not have any capital' do
        let(:application) { create :legal_aid_application, :with_applicant, :with_proceeding_types, :with_policy_disregards, :without_own_home, :with_passported_state_machine, :provider_entering_means }
