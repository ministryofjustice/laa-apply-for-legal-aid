...
RSpec.describe Providers::ProvidersController do
  ...
  context "when on test environment" do
    ...
    it "does not display CCMS contact_id and username attributes" do
  ...
  context "when on development environment" do
    ...
    it "displays CCMS contact_id and username attributes" do
      expect(page)
  ...
  context "when on development environment BUT user not found" do
    ...
    it "displays CCMS contact_id and username attributes as \"Not found\"" do
      expect(page)
