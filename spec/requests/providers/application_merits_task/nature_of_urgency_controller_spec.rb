...
module Providers
  module ApplicationMeritsTask
    RSpec.describe NatureOfUrgencyController do
      ...
      describe "PATCH /providers/applications/:legal_aid_application_id/nature_of_urgency" do
        subject(:post_nature_of_urgency) do
          patch(
            providers_legal_aid_application_nature_of_urgency_path(legal_aid_application),
        ...
        context "when hearing_date_set is false" do
          it "creates a new urgency with the values entered without a hearing date" do
            expect { post_nature_of_urgency }.to change(::ApplicationMeritsTask::Urgency, :count).by(1)
