    ...
    context 'invalid update' do
      context 'invalid params' do
        ...
        it 'shows an error for no amount entered' do
          expect(response.body).to include(I18n.t('errors.aggregated_cash_income.blank', category: 'Maintenance payments from a former partner', month: (Time.zone.today - 1.month).strftime('%B')))
        end
