  ...
  module V6
    FactoryBot.define do
      factory :cfe_v6_result, class: "CFE::V6::Result" do
        ...
        trait :with_partner_and_employment_and_ineligible_remarks do
          result { CFEResults::V6::MockResults.with_partner_and_employment_and_ineligible_remarks.to_json }
        end
