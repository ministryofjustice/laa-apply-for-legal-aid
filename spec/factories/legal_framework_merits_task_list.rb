FactoryBot.define do
  factory :legal_framework_merits_task_list, class: "LegalFramework::MeritsTaskList" do
    ...
    trait :pb003_pb059_application do
      serialized_data { build(:legal_framework_serializable_merits_task_list, :pb003_pb059_application).to_yaml }
    end
    ...
    trait :pb003_application do
      serialized_data { build(:legal_framework_serializable_merits_task_list, :pb003_application).to_yaml }
    end

    trait :pb003 do
      serialized_data { build(:legal_framework_serializable_merits_task_list, :pb003).to_yaml }
    end
