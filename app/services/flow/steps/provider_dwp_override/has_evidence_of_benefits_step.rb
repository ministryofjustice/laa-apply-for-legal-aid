  ...
  module Steps
    module ProviderDWPOverride
      HasEvidenceOfBenefitsStep = Step.new(
        path: ->(application) { Flow::Steps.urls.providers_legal_aid_application_has_evidence_of_benefit_path(application) },
        forward: lambda do |application, has_evidence_of_benefits|
