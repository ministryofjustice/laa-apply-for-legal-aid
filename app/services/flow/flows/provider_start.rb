  ...
  module Flows
    class ProviderStart < FlowSteps
      STEPS = {
        ...
        previous_references: Steps::ProviderStart::PreviousReferencesStep,
        ...
        change_of_names: Steps::ProviderStart::ChangeOfNamesStep,
        change_of_names_interrupts: Steps::ProviderStart::ChangeOfNamesInterruptsStep,
