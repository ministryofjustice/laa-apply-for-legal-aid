...
module MigrationHelpers
  class StateChanger
    STATE_CHANGES = [
      ...
      [:provider_assessing_means, :provider_entering_merits, %|provider_step in ('capital_assessment_results', 'start_chances_of_successes', 'date_client_told_incidents', 'respondents', 'statement_of_cases', 'success_likely', 'success_prospects')|],
      ...
      [:provider_checked_citizens_means_answers, :provider_entering_merits, %|provider_step not in ('capital_assessment_results', 'start_chances_of_successes', 'date_client_told_incidents', 'respondents', 'statement_of_cases', 'success_likely', 'success_prospects')|]
    ].freeze
