module DependantHelper
  ...
  def _name(dependant)
    build_ostruct(
      t("name", scope: "providers.means_summaries.income_assessment.dependants"),
      dependant.name,
    )
  end
  ...
  def date_of_birth(dependant)
    build_ostruct(
      t("date_of_birth", scope: "providers.means_summaries.income_assessment.dependants"),
  ...
  def relationship(dependant)
    build_ostruct(
      t("relationship", scope: "providers.means_summaries.income_assessment.dependants"),
  ...
  def in_full_time_education(dependant)
    build_ostruct(
      t("in_full_time_education", scope: "providers.means_summaries.income_assessment.dependants"),
  ...
  def income(dependant)
    build_ostruct(
      t("income", scope: "providers.means_summaries.income_assessment.dependants"),
  ...
  def assets(dependant)
    build_ostruct(
      t("assets", scope: "providers.means_summaries.income_assessment.dependants"),
