module ApplicationHelper
  ...
  def provider_header_navigation(header)
    if provider_signed_in?
      header.with_navigation_item(text: current_provider.username, href: providers_provider_path, current: current_page?(providers_provider_path))
      ...
      header.with_navigation_item(text: t("layouts.login"), href: home_path, current: false)
    end
  end
