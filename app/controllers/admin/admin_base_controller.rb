module Admin
  class AdminBaseController < ApplicationController
    before_action :check_vpn_ipaddr, :authenticate_admin_user!, :set_cache_buster, :set_scope, :redirect_report_only
  ...
  private
    ...
    def redirect_report_only
      return if controller_name == "reports"

      redirect_to admin_reports_path if current_admin_user.report_only?
    end
  end
end
