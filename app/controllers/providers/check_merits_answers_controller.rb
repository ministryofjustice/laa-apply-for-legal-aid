  ...
  class CheckMeritsAnswersController < ProviderBaseController
    ...
    def back_path
      if Setting.enable_evidence_upload?
        return providers_legal_aid_application_uploaded_evidence_collection_path(legal_aid_application) if legal_aid_application.required_document_categories.any?
