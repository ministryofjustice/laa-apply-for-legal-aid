module LegalAidApplications
  class LinkedApplicationForm < BaseForm
    ...
    def initialize(*args)
      ...
      @link_types << LinkType.new(link_type_code: "FAM_LEAD", description: "Family Lead")
      @link_types << LinkType.new(link_type_code: "FAM_CHILD", description: "Family Child")
    end
    ...
    def save
      ...
      elsif link_type_code == "FAM_CHILD"
        LinkedApplication.create!(lead_application: model, associated_application: application_to_link, link_description: "Family", link_type_code: "FAM")
      end
    end
