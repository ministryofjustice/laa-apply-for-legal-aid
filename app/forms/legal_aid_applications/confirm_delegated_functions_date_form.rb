module LegalAidApplications
  class ConfirmDelegatedFunctionsDateForm # rubocop:disable Metrics/ClassLength
    ...
    def save_proceeding_records
      proceeding_types_by_name.each do |proceeding|
        ...
        next unless delegated_functions_date
    ...
    def delegated_functions_dates
      @delegated_functions_dates ||= proceeding_types_by_name.filter_map do |type|
        date_fields(type.name, type.meaning) if confirm_delegated_functions_date == 'false'
      end
    end
