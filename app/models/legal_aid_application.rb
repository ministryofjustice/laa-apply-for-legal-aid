class LegalAidApplication < ApplicationRecord
  ...
  # TODO: can foreign key refs be moved to migration?
  has_one :lead_linked_application, class_name: "LinkedApplication", foreign_key: "associated_application_id"
  has_one :lead_application, class_name: "LegalAidApplication", through: :lead_linked_application
  has_many :associated_linked_applications, class_name: "LinkedApplication", foreign_key: "lead_application_id"
