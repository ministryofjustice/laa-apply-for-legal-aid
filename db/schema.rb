...
ActiveRecord::Schema[8.0].define(version: 2025_10_24_080229) do
  ...
  create_table "provider_skipped_announcements", id: false, force: :cascade do |t|
    t.uuid "announcement_id", null: false
    t.uuid "provider_id", null: false
    t.index ["provider_id", "announcement_id"], name: "idx_on_provider_id_announcement_id_bd7f4055f0"
  end
