...
ActiveRecord::Schema[8.1].define(version: 2026_06_25_125940) do
  ...
  create_table "admin_users", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "role", default: "digest_only"
  ...
  create_table "legal_aid_applications", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.boolean "return_to_review_and_print", default: false, null: false
    t.text "reviewed"
