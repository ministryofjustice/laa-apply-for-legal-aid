...
kubectl cp ./tmp/production.anon.sql -c web laa-apply-for-legalaid-uat/apply-ap-2555-anon-uat-db-apply-for-legal-aid-7678654784-lzsgt:./tmp/anonymised_db.sql
...
kubectl -c web exec apply-ap-2555-anon-uat-db-apply-for-legal-aid-7678654784-lzsgt -- rake db:import_to_uat
